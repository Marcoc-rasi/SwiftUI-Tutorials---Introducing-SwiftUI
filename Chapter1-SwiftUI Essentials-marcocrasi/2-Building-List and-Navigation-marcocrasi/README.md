...
4. **Add Images to the Resource Catalog:**
...
2. **Replace the Default Text View with a List:**
...
**Steps:**
1. **Eliminate the Two Static Rows of Reference Points:**
...
2. **Complete the Dynamically Generated List:**
...
4. **Remove the id Parameter in LandmarkList.swift:**
...
4. **Embed the Dynamic List of Waypoints in a NavigationSplitView:**
...
5. **Add the `navigationTitle(_:)` Modifier:**
...
2. **Update Preview to Paste Turtle Rock Image:**
...
5. **Change the Map Initializer to Accept a Position Input:**
...
8. **In LandmarkDetail, Pass the Necessary Data to your Custom Types:**
- With all connections established, the preview works again.
9. **Change Container from VStack to ScrollView in LandmarkDetail:**
...
2. **Tap the Toolbar Button to Reveal the Sidebar:**
